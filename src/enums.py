...
class InvestmentStrategy(Enum):
    ...
    TARGET_DATE = auto()    # Target date fund strategy
    DYNAMIC = auto()        # Dynamic asset allocation
    FIXED = auto()          # Fixed allocation strategy
    LIFECYCLE = auto()      # Lifecycle-based strategy
