"""
Participating whole life insurance product with reversionary bonuses.
"""
...
@dataclass
class ParticipatingWholeLifeBonus(WholeLifeInsurance):
    """Participating whole life insurance contract with reversionary bonuses."""
    ...
    def __init__(self, 
        ...
        self.dividend_option = DividendOption.PAID_UP_ADDITIONS
        self.bonus_scale = bonus_scale
        self.dividend_history: List[DividendHistory] = []
        self.asset_share: float = 0.0
        self.total_bonus: float = 0.0
    ...
    def calculate_bonus(self,
        ...
        # Calculate non-guaranteed bonus
        # This is the excess of asset share over GCV, scaled by bonus scale
        bonus = max(0, asset_share - gcv) * self.bonus_scale
        
        return bonus
    
    def get_total_face_amount(self) -> float:
        """Get total face amount including bonuses."""
        return self.face_amount + self.total_bonus 